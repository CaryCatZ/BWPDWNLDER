...
public class SingleThreadDownloaderServiceTest extends AutoSetUp {
    private SingleThreadDownloaderService service;
    @Before
    public void setUp() throws Exception {
        service = new SingleThreadDownloaderService(Main.getExecutor(), new SingleThreadDownloader());
        super.setUp();
    }
